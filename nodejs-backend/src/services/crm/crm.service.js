const { Crm } = require("./crm.class");
const createModel = require("../../models/crm.model");
const hooks = require("./crm.hooks");
...
module.exports = function (app) {
  ...
  app.use("/crm", new Crm(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("crm");

  // Get the schema of the collections
  app.get("/crmSchema", function (request, response) {
