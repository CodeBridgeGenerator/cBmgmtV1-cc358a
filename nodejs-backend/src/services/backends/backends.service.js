const { Backends } = require("./backends.class");
const createModel = require("../../models/backends.model");
const hooks = require("./backends.hooks");
...
module.exports = function (app) {
  ...
  app.get("/backendsSchema", function (request, response) {
