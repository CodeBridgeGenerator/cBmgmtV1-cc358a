const { Frontends } = require("./frontends.class");
const createModel = require("../../models/frontends.model");
const hooks = require("./frontends.hooks");
...
module.exports = function (app) {
  ...
  app.use("/frontends", new Frontends(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("frontends");

  // Get the schema of the collections 
  app.get("/frontendsSchema", function (request, response) {
