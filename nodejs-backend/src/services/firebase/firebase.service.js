const { Firebase } = require("./firebase.class");
const createModel = require("../../models/firebase.model");
const hooks = require("./firebase.hooks");
...
module.exports = function (app) {
  ...
  app.use("/firebase", new Firebase(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("firebase");

  // Get the schema of the collections
  app.get("/firebaseSchema", function (request, response) {
