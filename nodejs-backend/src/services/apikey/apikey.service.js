const { Apikey } = require("./apikey.class");
const createModel = require("../../models/apikey.model");
const hooks = require("./apikey.hooks");
...
module.exports = function (app) {
  ...
  app.use("/apikey", new Apikey(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("apikey");

  // Get the schema of the collections
  app.get("/apikeySchema", function (request, response) {
