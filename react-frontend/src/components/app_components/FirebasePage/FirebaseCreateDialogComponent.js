  ...
  const onSave = async () => {
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Create info",
        message: "Info Firebase created successfully",
      });
      ...
      props.alert({
        type: "error",
        title: "Create",
        message: "Failed to create in Firebase",
      });
    }
    setLoading(false);
  };
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="firebase-create-dialog-component"
      >
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="customUrl"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.customUrl}
              onChange={(e) => setValByKey("customUrl", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              ...
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.key}
              onChange={(e) => setValByKey("key", e.target.value)}
            />
          </span>
          <small className="p-error">
            {!_.isEmpty(error["key"]) ? (
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              id="projectNumber"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.projectNumber}
              onChange={(e) => setValByKey("projectNumber", e.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="webApiKey"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.webApiKey}
              onChange={(e) => setValByKey("webApiKey", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              ...
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.appId}
              onChange={(e) => setValByKey("appId", e.target.value)}
            />
          </span>
          <small className="p-error">
