    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Firebase",
          type: "error",
          message: error.message || "Failed get Firebase",
        });
      });
