...
import seederData from "./firebase.seeder.json";
...
const FirebaseSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(FirebaseSeederDialogComponent);
