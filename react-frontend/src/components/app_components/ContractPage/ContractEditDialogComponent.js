...
supportDate: _entity?.supportDate,
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info contract updated successfully" });
    ...
    return (
        <Dialog header="Edit Contract" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="contract-edit-dialog-component">
