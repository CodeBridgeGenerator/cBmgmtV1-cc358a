...
import seederData from "./contract.seeder.json";
...
const ContractSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ContractSeederDialogComponent);
