  ...
  useEffect(() => {
    ...
    client
      ...
      .find({
        query: {
          $limit: 10000,
          frontend: urlParams.singleFrontendsId,
          contract: urlParams.singleContractId,
          $populate: [
            {
              path: "createdBy",
              service: "users",
