...
import seederData from "./backends.seeder.json";
...
const BackendsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(BackendsSeederDialogComponent);
