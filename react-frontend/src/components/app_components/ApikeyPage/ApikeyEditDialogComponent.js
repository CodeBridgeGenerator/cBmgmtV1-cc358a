...
active: _entity?.active,
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info apikey updated successfully" });
    ...
    return (
        <Dialog header="Edit Apikey" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="apikey-edit-dialog-component">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="requests" className="w-full mb-3 p-inputtext-sm" value={_entity?.requests} onChange={(e) => setValByKey("requests", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
