...
import seederData from "./apikey.seeder.json";
...
const ApikeySeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ApikeySeederDialogComponent);
