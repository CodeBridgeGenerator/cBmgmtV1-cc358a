    ...
    client
      ...
      .find({
        query: {
          ...
          person: urlParams.singleBranchesId,
          opportunity: urlParams.singleOpportunityId,
          $populate: [
            {
              path: "createdBy",
              service: "users",
