...
otherCost: _entity?.otherCost,
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info crm updated successfully" });
...
const opportunityOptions = opportunity.map((elem) => ({ name: elem.name, value: elem.value }));
    ...
    return (
        <Dialog header="Edit Crm" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="crm-edit-dialog-component">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="appCost" className="w-full mb-3 p-inputtext-sm" value={_entity?.appCost} onChange={(e) => setValByKey("appCost", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="supportCost" className="w-full mb-3 p-inputtext-sm" value={_entity?.supportCost} onChange={(e) => setValByKey("supportCost", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="otherCost" className="w-full mb-3 p-inputtext-sm" value={_entity?.otherCost} onChange={(e) => setValByKey("otherCost", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
