...
import seederData from "./opportunity.seeder.json";
...
const OpportunitySeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(OpportunitySeederDialogComponent);
