...
import seederData from "./frontends.seeder.json";
...
const FrontendsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(FrontendsSeederDialogComponent);
