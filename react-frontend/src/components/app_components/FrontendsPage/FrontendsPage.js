  ...
  useEffect(() => {
    ...
    client
      ...
      .find({
        query: {
          $limit: 10000,
          firebase: urlParams.singleFirebaseId,
          $populate: [
            {
              path: "createdBy",
              service: "users",
