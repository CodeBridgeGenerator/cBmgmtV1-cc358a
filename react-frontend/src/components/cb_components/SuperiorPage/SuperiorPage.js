...
const SuperiorPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("superior")
            .find({ query: { $limit: 10000 , superior : urlParams.singleStaffinfoId ,subordinate : urlParams.singleStaffinfoId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
  ...
  const onClickSaveHiddenfields = (ff) => {
    ...
    const deleteRow = async () => {
        try {
            ...
            console.log({ error });
            props.alert({ title: "Superior", type: "error", message: error.message || "Failed delete record" });
        }
    };
...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="superior-add-button"/>
            ...
            <div className="grid align-items-center">
                <div className="col-12" role="superior-datatable">
                    <SuperiorDatatable items={data} fields={fields} onRowDelete={onRowDelete} onEditRow={onEditRow} onRowClick={onRowClick} searchDialog={searchDialog} setSearchDialog={setSearchDialog}
...
/>            
      ...
      />
            ...
            <SuperiorCreateDialogComponent entity={newRecord} onCreateResult={onCreateResult} show={showCreateDialog} onHide={() => setShowCreateDialog(false)}  />
