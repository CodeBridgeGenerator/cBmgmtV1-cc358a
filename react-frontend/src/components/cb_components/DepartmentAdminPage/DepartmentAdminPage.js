...
const DepartmentAdminPage = (props) => {
    ...
    const filename = "departmentAdmin";
    ...
    useEffect(() => {
        ...
        client
            ...
            .find({ query: { $limit: 10000 , departmentId : urlParams.singleDepartmentsId ,employeeId : urlParams.singleEmployeesId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
            ...
            .catch((error) => {
                ...
                setLoading(false);
                props.hide();
                props.alert({ title: "Department Admin", type: "error", message: error.message || "Failed get Department Admin" });
            });
  ...
  const onClickSaveHiddenfields = (ff) => {
    ...
    const deleteRow = async () => {
        try {
            ...
            console.log({ error });
            props.alert({ title: "Department Admin", type: "error", message: error.message || "Failed delete record" });
        }
    };
...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="departmentAdmin-add-button"/>
            ...
            <div className="grid align-items-center">
                <div className="col-12" role="departmentAdmin-datatable">
                    <DepartmentAdminDatatable items={data} fields={fields} onRowDelete={onRowDelete} onEditRow={onEditRow} onRowClick={onRowClick} searchDialog={searchDialog} setSearchDialog={setSearchDialog}
...
/>            
      ...
      />
            ...
            <DepartmentAdminCreateDialogComponent entity={newRecord} onCreateResult={onCreateResult} show={showCreateDialog} onHide={() => setShowCreateDialog(false)}  />
