...
import seederData from "./profileMenu.seeder.json";
...
const ProfileMenuSeederDialogComponent = (props) => {
  ...
  const onRun = async () => {
    ...
    setLoading(true);
    try {
      const _schema = await props.getSchema("profileMenu");
...
export default connect(mapState, mapDispatch)(ProfileMenuSeederDialogComponent);
