...
const [employees, setEmployees] = useState([]);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleDepartmentHOSId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
...
const employees = Array.isArray(res.employees)
            ? res.employees.map((elem) => ({ _id: elem._id, fullname: elem.fullname }))
            : res.employees
                ? [{ _id: res.employees._id, fullname: res.employees.fullname }]
                : [];
        setEmployees(employees);
            })
            .catch((error) => {
                console.log({ error });
                props.alert({ title: "DepartmentHOS", type: "error", message: error.message || "Failed get departmentHOS" });
            });
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Section Heads</h3>
                    <SplitButton
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Employees</label>
                    {employees.map((elem) => (
      ...
      <CommentsSection
        recordId={urlParams.singleDepartmentHOSId}
        user={props.user}
        alert={props.alert}
