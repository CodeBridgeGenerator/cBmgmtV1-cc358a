...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Fullname</label><p className="m-0 ml-3" >{_entity?.fullname}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Date Joined</label><p id="dateJoined" className="m-0 ml-3" >{_entity?.dateJoined}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Date Terminated</label><p id="dateTerminated" className="m-0 ml-3" >{_entity?.dateTerminated}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Supervisor</label>
                    {supervisor.map((elem) => (
