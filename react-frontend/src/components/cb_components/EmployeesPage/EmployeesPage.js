...
const EmployeesPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("employees")
            .find({ query: { $limit: 10000 , company : urlParams.singleCompaniesId ,department : urlParams.singleDepartmentsId ,section : urlParams.singleSectionsId ,position : urlParams.singlePositionsId ,supervisor : urlParams.singleEmployeesId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
  ...
  const onClickSaveHiddenfields = (ff) => {
    ...
    const deleteRow = async () => {
        try {
            ...
            console.log({ error });
            props.alert({ title: "Employees", type: "error", message: error.message || "Failed delete record" });
        }
    };
...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="employees-add-button"/>
            ...
            <div className="grid align-items-center">
                <div className="col-12" role="employees-datatable">
                    <EmployeesDatatable items={data} fields={fields} onRowDelete={onRowDelete} onEditRow={onEditRow} onRowClick={onRowClick} searchDialog={searchDialog} setSearchDialog={setSearchDialog}
...
/>            
      ...
      />
            ...
            <EmployeesCreateDialogComponent entity={newRecord} onCreateResult={onCreateResult} show={showCreateDialog} onHide={() => setShowCreateDialog(false)}  />
