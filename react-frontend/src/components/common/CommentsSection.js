...
const CommentsSection = ({ recordId, user, alert, serviceName }) => {
  ...
  const NavItem = ({ label, isActive }) => (
    <div
      className={`flex flex-col items-center font-semibold ${isActive ? "text-red-500" : "text-slate-700"} w-[150px]`}
    >
      <span className="mb-2">{label}</span>
      <div
        className={`gap-2.5 self-stretch ${isActive ? "bg-red-500" : "bg-zinc-200"} h-[5px] w-[150px]`}
      ></div>
    </div>
  );
    ...
    try {
      const updatedComments = comments.map((comment) => {
        if (comment._id === commentId) {
          ...
          client
            .service("comments")
            .patch(commentId, { resolved: updatedComment.resolved });
                          ...
                          <div className="flex justify-between items-center mb-2">
                            ...
                            <div className="flex items-center space-x-3">
                              ...
                              {comment.resolved ? (
                                <Checko
                                  onClick={() =>
                                    handleToggleResolve(comment._id)
                                  }
                            ...
                            {editingCommentId === comment._id ? (
                              <div className="flex items-center">
                                <InputText
                                  ...
                                  className="w-full p-inputtext-lg text-sm"
                                />
                                <div
                                  style={{
                                    display: "flex",
                  ...
                  : !showCommentInput && (
                      <div className="flex flex-col items-center mb-2">
                        <p className="text-muted text-center">
                          Give feedback or start discussion.
                        </p>
                        <Button
                          label="Add comment"
                          onClick={() => setShowCommentInput(true)}
                          className="mt-3 p-button-rounded p-button-primary"
                        />
                      </div>
                    )}
              </div>
        ...
        {showCommentInput && (
          <div className="card w-full">
            <div className="flex items-center mb-2">
              ...
              <small
                className="text-secondary text-xs ml-2"
                style={{ color: "#6A7178" }}
              >
            ...
            <div className="flex mt-3">
              ...
              <Button
                ...
                className="ml-2 p-button-rounded p-button-primary"
